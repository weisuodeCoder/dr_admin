    ...
    <template #body>
      <el-form :model="info.val" label-width="80" label-position="left" :rules="rules" ref="from">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="名称" prop="title">
              <el-input :disabled="disabled" v-model="info.val.title" placeholder="请输入名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :disabled="disabled" label="是否路由" prop="isRouter">
              <el-radio-group v-model="info.val.isRouter">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="标识符" prop="name">
              <el-input :disabled="disabled" v-model="info.val.name" placeholder="请输入标识符" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="上级菜单" prop="pid">
              ...
              <el-tooltip class="box-item" effect="dark" content="跟路由" placement="right">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="组件" prop="component">
              <el-input :disabled="disabled" v-model="info.val.component" placeholder="请输入组件路径" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="url路径" prop="path">
              <el-input :disabled="disabled" v-model="info.val.path" placeholder="请输入路径" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="图标" prop="icon">
              <el-input :disabled="disabled" v-model="info.val.icon" placeholder="请输入图标url" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-form-item label="描述信息">
          <el-input v-model="info.val.description" placeholder="描述信息" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea" />
        </el-form-item>
      </el-form>
    </template>
    <template #button>
...
import { apiCreate, apiUpdate, apiShow, apiList } from '@/api/core/sso/routers';
...
const rules = reactive({
  isRouter: [{ required: true, message: '必须项', trigger: 'change' }],
